          ...
          <div className="p-6 space-y-6 max-w-7xl mx-auto">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-muted-foreground">AI-powered trading signals with technical analysis.</p>
              </div>
              <div className="flex items-center gap-2">
                <Button
                ...
                <Button variant="outline" onClick={() => sendNotifications.mutate()} className="hover-elevate">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 bg-muted/30 p-4 rounded-xl border">
              <div className="space-y-2">
                <label className="text-xs font-semibold uppercase tracking-wider text-muted-foreground">Scan Timeframe</label>
                <select
                  value={scanInterval}
              ...
              <div className="space-y-2">
                <label className="text-xs font-semibold uppercase tracking-wider text-muted-foreground">Asset Limit</label>
                <input
                  type="number"
                  value={scanLimit}
