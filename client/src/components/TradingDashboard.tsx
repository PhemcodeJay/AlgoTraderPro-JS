...
export default function TradingDashboard({
  ...
  // Simulate progress bar during scanning
  useEffect(() => {
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              >
                ...
                {isScanning ? `Scanning ${Math.round(scanProgress)}%` : "Scan Signals"}
                {isScanning && (
                  <div 
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <div className="flex items-center gap-2">
                        ...
                        <Badge variant="outline" className="text-[10px]">{signal.interval === '5' ? '5m' : signal.interval === '60' ? '1h' : signal.interval === '240' ? '4h' : '1d'}</Badge>
                      </div>
                      <div>
